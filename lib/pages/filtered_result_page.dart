...
enum MovieCategory { topRated, nowPlaying, popular }
...
class _FilteredResultPageState extends State<FilteredResultPage> {
  ...
  void initState() {
    super.initState();
    _moviesFuture = _getMoviesByCategory(widget.category);
  }

  Future<List<Movie>> _getMoviesByCategory(MovieCategory category) {
